      ...
      <div class="row" >
        <div class="col-md-6 col-md-offset-3 col-sm-12 col-sm-offset-3 col-xs-12" id="login-form">
          ...
          <div class="row">
			...
			<img src="ope.jpg"  align="center"   height="449px" width="668px" usemap="#book"  onclick="window.alert('nothing happened!')">
</br>
<input type="submit" align="center" class="col-md-12 col-sm-12 col-xs-12"  value="Return to Main Hall" onclick='window.location.href="living.html"' >
<map name="book">
<area shape='rectangle' coords="290,120,410,380"  onclick="window.location.href='eromo.html'"/>
