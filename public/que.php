...
<link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
 ...
 <section class="container-fluid" id="inner-block">
    ...
    <div>
      <a class="btn btn-default pull-right" id="forum-link" href="/logout">
          Logout
        </a>
     <div>
	...
	<img src="b.jpg"  align="center" class="col-md-12 col-sm-12 col-xs-12"  height="349px" onclick="window.alert('nothing is going to  happen!')">
<?php if($flag) echo "</br>wrong answer"?>
