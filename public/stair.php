...
<?php
session_start();
if(!empty($_SESSION['key'])&&isset($_SESSION['key'])&&$_SESSION['key']=="true")
{
echo"im in!!!!";
header('location:thway.php');
}
?>
<html>
<head>
 ...
 <section class="container-fluid" id="inner-block">
      <div class="row" id="short-head">
        <a class="btn btn-default pull-left" id="login-link" href="/">
          Obscura
    <div>
    <a class="btn btn-default pull-right" id="forum-link" href="/logout" target="_blank">
          Logout
        </a>
      </div>
    ...
    <a class="btn btn-default pull-right" id="leaderboard" href="/leaderboard">
      ...
      <div class="row" >
		...
		<img src="hallway.jpg"  align="center" height="449px" width="299px" usemap="#hallway"  onclick="window.alert('nothing happened!!')">
</br>
<input type="submit" value="Return to Main Hall"  align="center" class="col-md-12 col-sm-12 col-xs-12" onclick='window.location.href="living.html"' >
<map name='hallway'>


<area shape="rect" coords="20,130,90,300" alt="Image Map" style="outline:none;"  onclick="alert('the door is locked')"/>
<area shape="rect" coords="20,10,120,60" alt="Image Map" style="outline:none;"  onclick='window.location.href="attic.html"' />
<area shape="rect" coords="130,70,160,380" alt="Image Map" style="outline:none;"  onclick='window.location.href="droom.html"' />
<area shape="rect" coords="180,20,270,450" alt="Image Map" style="none;"  onclick='window.location.href="roomf.html"' />
</map>
   ...
   <div id="bottomnav" class="row"  >
      ...
      <div class="col-md-7 col-sm-7 col-xs-5" >
        <marquee><p class="text-primary" style="color:black"></p></marquee>  
      </div>
