...
{if($_POST['answer']=="starwars")
header("Location:opi.html");
else
$flag=true;
}
 ...
 <section class="container-fluid" id="inner-block">
    ...
    <a class="btn btn-default pull-right" id="leaderboard" href="/leaderboard">
      ...
      <div class="row" >
		...
		<img src="safe.jpg"  align="center"  height="349px" width="668px"   onclick="window.alert('nothing is going to  happen!')">
