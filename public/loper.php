...
{if($_POST['answer']=="alloy"|| $_POST['answer']=="loyal")
{$_SESSION['key']="true";
header("location:slip.html");
}
else
$flag=true;
}
 ...
 <section class="container-fluid" id="inner-block">
    ...
    <a class="btn btn-default pull-right" id="leaderboard" href="/leaderboard">
      ...
      <div class="row" >
		...
		<img src="safe.jpg" align="center" class="col-md-12 col-sm-12 col-xs-12"  height="400px" width ="600px">
