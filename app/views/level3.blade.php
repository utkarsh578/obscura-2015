...
<link href="http://maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css" rel="stylesheet">
 ...
 <section class="container-fluid" id="inner-block">
  ...
  <script>
$(document).ready(function(){$("#hidden").on("keydown", function (e) {
    return false;
});});
</script>
  ...
  <!-- If a violet house is made out of violet bricks, a blue house is made out of blue bricks and a red house is made out of red bricks, what is a green house made of? -->
</html>