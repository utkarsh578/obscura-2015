        ...
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-12 text-center obscura-form" id="login-form">
         ...
         <div id="login-block">
		            ...
		            <div class="social-login">
		              ...
		              <button class="btn btn-default login-fb" onclick="window.location.href='/facebook'"><i class="fa fa-facebook-square"></i><span>Login with Facebook</span></button>
		              <button class="btn btn-default login-tw" onclick="window.location.href='/googleAuth'"><i class="fa fa-google-plus-square"></i><span>Login with Google</span></button>
